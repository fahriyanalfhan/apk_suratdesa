...
class M_surat extends CI_Model
{
	...
	public function sktm_update($data, $id)
	{
		$this->db->where('id', $id);
		$this->db->update('surat_tidak_mampu', $data);
	}
	...
	public function skk_update($data, $id)
	{
		$this->db->where('id', $id);
	...
	public function spak_update($data, $id)
	{
		$this->db->where('id', $id);
		$this->db->update('surat_kelahiran', $data);
	}
	...
	public function skp_update($data, $id)
	{
		$this->db->where('id', $id);
		$this->db->update('surat_keterangan_pengantar', $data);
	}
	...
	public function getSuratByNomor($nomor_surat)
	{
		$this->db->where('nomor_surat', $nomor_surat);
		$query = $this->db->get('surat');  // Pastikan tabel 'surat' sesuai dengan database Anda
