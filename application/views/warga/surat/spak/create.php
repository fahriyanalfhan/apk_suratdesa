            					...
            					<div class="card-body">
            						<form action="<?= base_url('spak/proses') ?>" method="post" enctype="multipart/form-data">
            							<?php foreach ($data as $d) { ?>
            								<h6 class="text-center">Data Pelapor</h6>
            								...
            								<div class="form-group">
            									...
            									<input type="text" name="nik_ayah" class="form-control" value="<?= set_value('nik_ayah') ?>" required>
            								</div>
            								<div class="form-group">
            									<label for="">Tempat Lahir Ayah</label>
            									<input type="text" name="te_lahir_ayah" class="form-control" value="<?= set_value('te_lahir_ayah') ?>" required>
            								</div>
            								<div class="form-group">
            									<label for="">Tanggal Lahir Ayah</label>
            									<input type="date" name="ta_lahir_ayah" class="form-control" value="<?= set_value('ta_lahir_ayah') ?>" required>
            								</div>
            								...
            								<div class="form-group">
            									...
            									<input type="text" name="nik_ibu" class="form-control" value="<?= set_value('nik_ibu') ?>" required>
            								</div>
            								<div class="form-group">
            									<label for="">Tempat Lahir Ibu</label>
            									<input type="text" name="te_lahir_ibu" class="form-control" value="<?= set_value('te_lahir_ibu') ?>" required>
            								</div>
            								<div class="form-group">
            									<label for="">Tanggal Lahir ibu</label>
            									<input type="date" name="ta_lahir_ibu" class="form-control" value="<?= set_value('ta_lahir_ibu') ?>" required>
            								</div>
            								<div class="form-group">
            								...
            								<div class="form-group">
            									...
            									<input type="text" name="tempat_lahir_b" class="form-control" value="<?= set_value('tempat_lahir_b') ?>" id="" required>
            								</div>
            								<small class="text-danger"><?php form_error('tempat_lahir') ?></small>
            								<div class="form-group">
            									<label for="">Tanggal Lahir</label>
            									<input type="date" name="tanggal_lahir_b" class="form-control" class="<?= set_value('tanggal_lahir_b') ?>" id="" required>
            								</div>
            								...
            								<h6 class="text-center">Data Saksi 1</h6>
            								<div class="form-group">
            									<label for="">Nama Saksi 1</label>
            									<input type="text" name="nama_s1" class="form-control" value="<?= set_value('namas1') ?>" required>
            								</div>
            								<small class="text-danger"><?php form_error('nama_s1') ?></small>
            								<div class="form-group">
            									<label for="">Nik Saksi 1</label>
            									<input type="text" name="nik_s1" class="form-control" value="<?= set_value('niks1') ?>" required>
            								</div>
            								<small class="text-danger"><?php form_error('nik_s1') ?></small>
            								<div class="form-group">
            									<label for="">Alamat Saksi 1</label>
            									<small class="text-danger">*Wajib !</small>
            									<textarea name="alamat_s1" id="" cols="30" rows="5" class="form-control" required><?= set_value('alamats1') ?></textarea>
            								</div>
            								<h6 class="text-center">Data Saksi 2</h6>
            								<div class="form-group">
            									<label for="">Nama Saksi 2</label>
            									<input type="text" name="nama_s2" class="form-control" value="<?= set_value('namas2') ?>" required>
            								</div>
            								<small class="text-danger"><?php form_error('nama_s1') ?></small>
            								<div class="form-group">
            									<label for="">Nik Saksi 2</label>
            									<input type="text" name="nik_s2" class="form-control" value="<?= set_value('niks2') ?>" required>
            								</div>
            								<small class="text-danger"><?php form_error('nik_s1') ?></small>
            								<div class="form-group">
            									<label for="">Alamat Saksi 2</label>
            									<small class="text-danger">*Wajib !</small>
            									<textarea name="alamat_s2" id="" cols="30" rows="5" class="form-control" required><?= set_value('alamats2') ?></textarea>
            								</div>
            								<div class="form-group">
            								...
            								<div class="form-group">
            									<label for="">Foto Surat Kelahiran RS/Bidan</label>
            									<small class="text-danger">*Wajib. JPG|PNG</small>
            									<input type="file" name="file_kel" value="<?= set_value('file_kel') ?>" class="form-control">
            								</div>
            								<div class="form-group">
            									<label for="">Foto KTP Sanksi 1</label>
            									<small class="text-danger">*Wajib. JPG|PNG</small>
            									<input type="file" name="file_ktp1" value="<?= set_value('file_ktp1') ?>" class="form-control">
            								</div>
            								<div class="form-group">
            									<label for="">Foto KTP Sanksi 2</label>
            									<small class="text-danger">*Wajib. JPG|PNG</small>
            									<input type="file" name="file_ktp2" value="<?= set_value('file_ktp2') ?>" class="form-control">
            								</div>
            							<?php } ?>
            							<div class="form-group">
