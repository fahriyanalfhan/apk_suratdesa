    ...
    <div class="container mt-3 page">
        <div class="sub-page">
            ...
            <div class="text-surat">
                <p>Kepala Desa Lagadar Kecamatan Margaasih Kabupaten Bandung, dengan ini menerangkan
                    bahwa :</p>
                <table class="ms-5">
                    <?php foreach ($data as $d) { ?>
                        <tr>
                            <td>Nama</td>
                            <td>: </td>
                            <td><span class="fw-bold"><?= $d->ibu ?></span></td>
                        </tr>
                        <tr>
                            <td>Tempat/Tgl Lahir</td>
                            <td>: </td>
                            <td><?= $d->te_lahir_ibu ?>, <?= $d->ta_lahir_ibu ?></td>
                        </tr>
                        <tr>
                            <td>NIK</td>
                            <td>: </td>
                ...
                <table class="ms-5">
                    <?php foreach ($data as $d) { ?>
                        <tr>
                            <td>Nama</td>
                            <td>: </td>
                            <td><span class="fw-bold"><?= $d->ayah ?></span></td>
                        </tr>
                        <tr>
                            <td>Tempat/Tgl Lahir</td>
                            <td>: </td>
                            <td><?= $d->te_lahir_ayah ?>, <?= $d->ta_lahir_ayah ?></td>
                        </tr>
                        <tr>
                            <td>NIK</td>
                            <td>: </td>
                ...
                <br>
                <?php foreach ($data as $d) { ?>
                    <p>Pada tanggal <span class="fw-bold"><?= $d->tanggal_lahir_b ?></span> di <?= $d->tempat_lahir_b ?>
                        telah melahirkan seorang anak, jenis kelamin <span class="fw-bold"><?= $d->jekel_b ?></span> yang diberi nama :</p>
                    <div class="d-flex justify-content-center">
                        <p>
                            <span class="line"></span>
                            <span class="fw-bold"><?= $d->nama_bayi ?></span>
                            <span class="line"></span>
                        </p>
