        ...
        <div class="sub-page">
            <center>
                <table width="100%">
                    <tr>
                        <td>
                            <img src="<?= base_url() ?>./assets/logo/logo.jpg" width="100px" height="130px">
                        </td>
                        <td>
                            <center>
                                <strong>
                                    <h5>PEMERINTAHAN KABUPATEN XXXX</h5>
                                    <h5>KECAMATAN MUALA</h5>
                                    <h5>DESA KUALA</h5>
            ...
            <div class="text-surat">
                <p>Yang bertanda tangan di bawah ini Kepada Desa Kuala, Kecamatan Welahan Kabupaten Jepara,
                ...
                <div class="kades float-end">
                    <span class="mb-n2">Banjar, <?= date('d M Y') ?></span>
                    <p>KEPALA DESA KUALA</p>
                    <img src="<?= base_url('./assets/ttd/ttd.png') ?>" class="ttd-kades" width="80%" style="margin-top: -25px; z-index:9999;">
                    <p class="fw-bold" style="margin-top: -30px; z-index:2;">Muhamad Nador</p>
                </div>
            </div>
        </div>
    </div>
