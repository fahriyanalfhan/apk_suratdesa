            <div class="main-content container-fluid">
            	<div class="page-title">
            		<h3>Dashboard</h3>
            		<h5 class="text-subtitle text-muted text-bold">Selamat Datang di Aplikasi Pelayanan Administrasi Kependudukan </h5>
            	</div>
            				...
            				<div class="col-lg-12">
            					<div class="card">
            						<div class="card-body bg-success">
            							<h4 class="font-bold text-white">SELAMAT DATANG DI APLIKASI PELAYANAN ADMINISTRASI KEPENDUDUKAN</h4>
            									...
            									<div class="col-sm-6">
            										<div class="card">
            											<div class="card-body">
            												...
            												<p class="card-text text-dark ml-3">Silahkan memilih jenis surat dan request permohonan surat pada menu pelayanan surat, serta lengkapi seluruh data yang dibutuhkan untuk request surat, kemudian di kirim dan menunggu persetujuan petugas.</p>
            											</div>
            										</div>
            										<div class="card">
            											<div class="card-body">
            									...
            									<div class="col-sm-6">
            										<div class="card">
            											<div class="card-body">
            												...
            												<p class="card-text text-dark ml-3">Silahkan cetak surat pada menu Surat dan pilih Request Surat yang telah disetujui, surat dapat diambil langsung di kantor Desa apabila ada status <span class="badge bg-info">Ambil Surat</span></p>
            											</div>
            										</div>
            										<div class="card">
            											<div class="card-body">
            												<h4 class="card-title text-dark">4. Permohonan Ditolak</h4>
            												<p class="card-text text-dark ml-3">Silahkan cetak surat pada menu Surat dan cek komentar untuk cek data yang tidak lengkap, kemudian lakukan request surat kembali dengan mengedit pada menu aksi.</p>
            											</div>
            										</div>
            									</div>
            								</div>
