...
?>
<div id="sidebar" class='active dark'>
    <div class="sidebar-wrapper active text-white">
        <div class="sidebar-header">
            <img src="<?= base_url() ?>./assets/logo/logo.png" style="width:50%; height:25%; margin-left: auto; margin-right: auto; display: block;">
        </div>
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <?php if ($this->session->userdata('role_id') == 1) { ?>
                    ...
                    <li class="sidebar-item  <?= $this->uri->segment(1) == 'laporan' ? 'active ' : '' ?>">
...
<div id="main">
    <nav class="navbar navbar-header navbar-expand navbar-light">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <h4 style="margin-left:10px; margin-top:15px;">Aplikasi Pelayanan Administrasi Kependudukan</h4>
