            <div class="main-content container-fluid">
                ...
                <a href="<?= base_url('history-surat-keterangan-pengantar') ?>" class="btn btn-primary btn-sm mb-2"><i class="bi bi-arrow-left-circle-fill"></i> Kembali</a>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="table-responsive overflow-auto">
                                        <form action="<?= base_url('skp/update') ?>" method="post" enctype="multipart/form-data">
                                            ...
                                            <table class="table" style="width:100%">
                                                <?php foreach ($datas as $data) { ?>
                                                    ...
                                                    <tr>
                                                        <td>File Surat Pengantar RT</td>
                                                        <td>: </td>
                                                        <td> <img src="<?= base_url('./assets/file_kel/') . $data->file_rt ?>" class="img-thumbnail" style="width:20%">
