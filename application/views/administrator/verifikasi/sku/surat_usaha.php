            											...
            											<td>
            												<?php if ($this->session->userdata('role_id') == 1) { ?>
            													...
            													<?php } else if ($data->status == 'Diterima') { ?>
            														<div class="btn-group">
            															<a href="<?= base_url('cetak-surat-usaha/' . $data->id . '?nomor=' . $data->nomor_surat) ?>" class="btn btn-primary btn-sm mx-1" target="blank_"><i class="bi bi-printer-fill"></i></a>
            													...
            													<?php } else if ($data->status == 'Ditolak') { ?>
            														<div class="btn-group">
            															<button class="btn btn-info btn-sm mx-1" data-toggle="modal" data-target="#tambahKomentar<?= $data->id ?>">Komentar</button>
            															<button type="button" class="btn btn-danger sm" data-toggle="modal" data-target="#hapus<?= $data->id ?>">
            																<i class="bi bi-trash-fill"></i>
            															</button>
            														</div>
