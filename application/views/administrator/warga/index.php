                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="btn-group">
                                                                ...
                                                                <!-- <a onclick="linkopen('<?= $data->kk; ?>')" class="btn btn-primary  btn-sm">Anggota</a> -->
                                                            </div>
            ...
            <script>
                function linkopen(kk) {
                    window.open("<?php echo base_url('detail-warga-anggota/'); ?>" + kk, "_blank", "toolbar=yes,scrollbars=yes,resizable=yes,top=500,left=500,width=900,height=999");
                }
            </script>