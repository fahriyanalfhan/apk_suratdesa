...
class Warga extends CI_Controller
{
	...
	public function create()
	{
		...
		$this->form_validation->set_rules('kk', 'Kartu Keluarga', 'required|min_length[16]|max_length[16]', [
			'required' => 'Kartu Keluarga tidak boleh kosong!',
			'min_length' => 'KK Warga minimal 16 karakter!',
			'max_length' => 'KK Warga maksimal 16 karakter!'
		]);
	...
	public function detail($id)
	{
		...
		if ($detail) {
			$kk = $detail->kk;
			$anggota_keluarga = $this->M_warga->getDetailAnggota($kk);
			$nik = $detail->nik;
		} else {
			$anggota_keluarga = [];
			$nik = '';
		...
		$data = array(
			...
			'warga'    => $this->M_warga->getDetailAnggota($id)
		);
	...
	public function detail_anggota($id)
	{
		...
		$this->load->view('layout/header', $data);
		$this->load->view('administrator/warga/detail_anggota', $data);
		$this->load->view('layout/footer', $data);
	}
